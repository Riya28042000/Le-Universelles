...
class RatingWithPic extends StatelessWidget {
  @override
          ...
          itemBuilder: (BuildContext ctxt, int index) {
            return Container(
              ...
              width: ScreenUtil().setWidth(327),
                    ...
                    child: Padding(
                      padding: const EdgeInsets.only(top:LaUniversellesConstants.horizontalPadding/2, left:LaUniversellesConstants.horizontalPadding/2),
                      child: Container(
